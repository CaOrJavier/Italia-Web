...
| **Alternativas** | Pestaña propia arriba a la izquierda, fuera de la navegación de abajo. El plan actual frente a dos versiones alternativas del itinerario (menos kilómetros, más noches en el mismo sitio), día a día, con su coste, su balance de qué ganas y qué pierdes, y qué falta por verificar. Es de lectura: no toca el itinerario ni el estado |
